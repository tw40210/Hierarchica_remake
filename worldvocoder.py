...
def create_MIDI(note_list):
    ...
    for note in note_list:
        ...
        duration = convert_seconds_to_quarter(2-time+delay, bpm)
...
while True:
    ...
    tempo_list = tempo_making(interval, onSeqout)
    if count % 2 == 1:
    ...
    print("chord_temp, chord_step", chord_temp, chord_step)
    mide_file = create_MIDI(note_list)
