...
class ResNet_simple(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.down_conv2 = nn.Conv2d(16, 32, kernel_size=(3, 3), stride=2, padding=(1, 1),
                               bias=False)
        self.layer3 = self._make_layer(block, 16, layers[2], stride=3,
                                       dilate=replace_stride_with_dilation[1])
        self.down_conv3 = nn.Conv2d(32, 16, kernel_size=(3, 3), stride=3, padding=(1, 1),
                               bias=False)
